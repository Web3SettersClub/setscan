//
// Setheum chain errors
// -----------------
//
// Setheum chain modules and its indexes:
//
// https://github.com/Setheum-Labs/Setheum/blob/master/runtime/src/lib.rs#L765
//
//

export const setheumChainErrors = [
  // System
  {
    index: 0,
    module: 'System',
  ...
  // Currencies
  {
    index: 7,
    module: 'Currencies',
    // from https://github.com/Setheum-Labs/Setheum/blob/master/modules/currencies/src/lib.rs#L83
    errors: [
      {
        index: 0,
  ...
  // EvmAccounts
  {
    index: 20,
    module: 'EvmAccounts',
    // from https://github.com/Setheum-Labs/Setheum/blob/master/modules/evm-accounts/src/lib.rs#L87
    errors: [
      {
        index: 0,
  ...
  // Evm
  {
    index: 21,
    module: 'Evm',
    // from https://github.com/Setheum-Labs/Setheum/blob/master/modules/evm/src/lib.rs#L339
    errors: [
      {
        index: 0,
  ...
  // EVMBridge
  {
    index: 22,
    module: 'EVMBridge',
    // from https://github.com/Setheum-Labs/Setheum/blob/master/modules/evm-bridge/src/lib.rs#L36
    errors: [
      {
        index: 0,
        name: 'ExecutionFail',
  ...
  // Poc
  {
    index: 51,
    module: 'Poc',
    // from https://github.com/Setheum-Labs/Setheum/blob/master/modules/poc/src/lib.rs#L145
    errors: [
      {
        index: 0,
